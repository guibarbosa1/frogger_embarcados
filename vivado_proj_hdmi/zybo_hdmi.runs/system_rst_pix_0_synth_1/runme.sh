...
HD_PWD='C:/Users/811692/Downloads/frogger/vivado_proj_hdmi/zybo_hdmi.runs/system_rst_pix_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_pix_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_pix_0.tcl
